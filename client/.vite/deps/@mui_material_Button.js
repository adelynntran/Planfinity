...
import {
  capitalize_default
} from "./chunk-74JV4TBK.js";
import {
  memoTheme_default
} from "./chunk-DL7TWJHG.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var ButtonGroupContext = React11.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React12.createContext(void 0);
if (true) {
...
var Button = React13.forwardRef(function Button2(inProps, ref) {
  const contextProps = React13.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React13.useContext(ButtonGroupButtonContext_default);
